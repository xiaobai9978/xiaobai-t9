...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" rev-parse "${ref}"
...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" show-ref "develop"
  WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
...
if(need_stash)
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Program Files/Git/bin/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src'."
    ...
    execute_process(
      COMMAND "C:/Program Files/Git/bin/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/weasel/deps/boost_1_76_0/tools/cmake/test/boost_fetch/out/build/x64-Debug/_deps/boostorg_assert-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
